# README for Philosophy of intro Course Template
...
A Quarto-based course website for Philosophy of intro, with support for multi-year iterations (e.g., 2025 and 2026).
...
Title: Philosophy of intro\\
Years Supported: 2025, 2026 (with dedicated folders for materials)\\

This site hosts lectures, exercises, readings, and resources for university-level intro in philosophy. Includes daily exercises, bibliography, and custom helpers for course delivery.

This template will be updated in the coming weeks, based on things I've implemented downstream ([DS105 (internal 2025/2026)](https://course.phil.intro.github.io/DS105/) and [ME204 (2025)](https://course.phil.intro.github.io/ME204/) most recently). Planned enhancements include:
...
* Year-specific folders (e.g., 2025-intro, 2026_intro)
...
Ideal for structured intro courses with evolving annual content.
Rendered site: https://redapemusic35.github.io/course.phil.intro.github.io/
